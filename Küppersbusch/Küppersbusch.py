...
class HomekueppersbuschSpider(scrapy.Spider):
    ...
    def parse_item(self, response, **kwargs):
        manuals = ['Manuals','Handleidingen','Bedienungsanleitungen','Instrukcje obsługi','Руководства пользователей'\
                    ,'Manuais','Manual de instrucciones','Ръководство','Εγχειρίδια']

        pdfs = response.css("a[href*='.pdf'] strong::text").getall()
